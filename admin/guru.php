...
$result = mysqli_query($conn, "SELECT * FROM tb_guru tk JOIN tb_jabatan tj ON tk . id_jabatan = tj . id_jabatan");
...
<div class="row">
   ...
   <div class="col-md-6">
      ...
      <button type="button" class="btn btn-dark" id="jadwal-absen-guru">
                Jadwal absen
            </button>
            <button type="button" class="btn btn-secondary mr-2" id="click-master-jabatan">
                Master Jabatan
            </button>
         <div class="btn-group">

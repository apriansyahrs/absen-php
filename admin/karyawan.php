...
<div class="row">
   ...
   <div class="col-md-6">
      <div class="text-md-right mb-4 mb-md-0">
       <a href="#" class="mr-2" id="click-master-jabatan">Master Jabatan</a>
         <div class="btn-group">
      ...
      <div class="py-2">
         <div class="px-4 py-2 row">
            ...
            <div class="col-md-6 my-md-auto text-md-right mt-3 mt-md-0">
               Absen Masuk (<?= $j_karyawan['masuk_mulai'] . ' - ' . $j_karyawan['masuk_akhir'] ?>) <br> Absen Pulang
               (<?= $j_karyawan['pulang_mulai'] . ' - ' . $j_karyawan['pulang_akhir'] ?>) <br> Absen Pulang (Jumat)
               (<?= $j_karyawan['pulang_mulai_jumat'] . ' - ' . $j_karyawan['pulang_akhir_jumat'] ?>)
            </div>
         </div>
...
<script>
   ...
   $('#click-master-jabatan').click(function() {
      $('html, body').animate({
         scrollTop: '0'
      }, 200);
      history.pushState('Master jabatan', 'Master jabatan', '?menu=master-jabatan');

...
$r = mysqli_query($conn, "SELECT * FROM tb_guru WHERE id_guru = '$_SESSION[guru]'");
...
$result = mysqli_query($conn, "SELECT * FROM tb_kegiatan_guru kg JOIN tb_guru g ON kg.id_guru = g.id_guru WHERE kg.id_guru = '$_SESSION[guru]' && kg.tanggal_kegiatan LIKE '" . $month . "%' ORDER BY g.nama ASC");
$nomor = 1;
